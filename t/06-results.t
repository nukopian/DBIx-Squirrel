...
is_deeply( $artist->{transforms_initial},  [],    'transforms_initial ok' );
is_deeply( $artist->{transforms}, $artist->{transforms_initial},
    'transforms ok' );
...
my $expected = [ 'Rush', 'Envy of None', 'Alex Lifeson', 'Simply Red', 'Skank',
    'Smashing Pumpkins' ];
...
is( $artists->{cache_size}, &DBIx::Squirrel::Iterator::CACHE_SIZE_LIMIT,
    'artists->{cache_size}' );
