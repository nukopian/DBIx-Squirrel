...
-   **TESTS**
    ...
    -   Got a steer from TWATA to look at TRWYANT PPIx::Regexp for a possible
        solution to /Can't locate object method "e" via package "warnings"/
        in some Strawberry Perl builds. Thanks, both!
    -   Riffing-off the suggestion above, I've ended up using Mons Andersons
        Test::More::UTF8 and preliminary results look good. One of the Win32
        Strawberry Perl 5.14.4 build is now green (yay!)
-   **TEST COVERAGE**
